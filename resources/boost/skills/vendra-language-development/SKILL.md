...
Treat `app-modules/vendra-language` as the source of language domain behavior and Filament admin UI.
...
- Run module checks from the package when possible: `composer --working-dir=app-modules/vendra-language test` and `composer --working-dir=app-modules/vendra-language analyse`.
